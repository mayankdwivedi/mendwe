...
<form method="post" action="registerUser.html">
  ...
  <input type="text" style="width:480px; height:40px; font-size:20px;" placeholder="First Name" name="firstName" /><br/>
  <input type="text" style="width:480px; height:40px; font-size:20px;" placeholder="Last Name" name="lastName" /><br/>
